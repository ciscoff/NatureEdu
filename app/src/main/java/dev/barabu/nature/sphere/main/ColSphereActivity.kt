...
import dev.barabu.nature.sphere.main.gl.ColSphereRenderer

/**
 * Одноцветная сфера
 */
class ColSphereActivity : BaseActivity() {
    private lateinit var glSurfaceView: GLSurfaceView

    private lateinit var renderer: ColSphereRenderer

    private var isRendererSet = false

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        renderer = ColSphereRenderer(this)
