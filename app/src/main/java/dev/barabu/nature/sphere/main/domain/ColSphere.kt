...
import dev.barabu.nature.sphere.main.domain.ColVertexArray
...
class ColSphere(
    ...
    private val vertexArray: ColVertexArray
    ...
    init {
        vertexArray = if (isFlat) {
            ...
            ColVertexArray(
                VertexBuffer(buildVerticesSmooth()),
     ...
     */
    private fun buildVerticesSmooth(withNormals: Boolean = true): FloatArray {
    ...
    private fun getVertices(): List<Vertex> =
        with(buildVerticesSmooth(withNormals = false)) {
